---
layout: default
title: Manage Multiple Customer Orders
nav_order: 5

parent: Sales
---

# Manage Multiple Sales orders from customers


Soft1 ERP has a powerful pricelist feature to support a pricing strategy tailored to your business. A pricelist is a list of prices or price rules that Odoo searches to determine the suggested price. You can set several critarias to use a specific price: periods, min. sold quantity (meet a minimum order quantity and get a price break), etc.
